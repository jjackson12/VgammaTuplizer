...
cp -r $CMSSW_DIR/src/VgammaTuplizer/Ntuplizer/JEC .
cp -r $CMSSW_DIR/src/VgammaTuplizer/Ntuplizer/JER .
cp -r $CMSSW_DIR/src/VgammaTuplizer/Ntuplizer/JSON .
cp -r $CMSSW_DIR/src/VgammaTuplizer/Ntuplizer/RunLumiEventLists .
