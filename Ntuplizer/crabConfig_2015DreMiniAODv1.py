...
config.General.requestName = 'WZgammaNtuples_2015DreMiniAodV1_Dec22'
config.General.workArea = 'crab_jobs_2015DreMiniAodV1_Dec22'
...
config.Data.outputDatasetTag = 'WZgammaNtuples_2015DreMiniAodV1_Dec22'
