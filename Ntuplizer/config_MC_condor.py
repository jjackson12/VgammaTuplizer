...
from VgammaTuplizer.Ntuplizer.ntuplizerOptions_SIG_cfi import config
...
process.TFileService = cms.Service("TFileService",
                                    fileName = cms.string('/home/hakala/cmssw/CMSSW_8_0_26_patch1/src/VgammaTuplizer/Ntuplizer/Hgamma2016Sig_m%s/flatTuple_sig%s_%s.root' % (sigMass, sigMass, fileNumber))
