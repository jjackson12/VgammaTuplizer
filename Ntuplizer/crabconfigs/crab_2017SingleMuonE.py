...
config.General.requestName = 'Wgamma94XSingleMuonTuples_%s_2017E'%"Jul13"
config.General.workArea = 'crab_jobs_2017E_%s'%"Jul13"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuples_%s_2018E'%"Jul13"
