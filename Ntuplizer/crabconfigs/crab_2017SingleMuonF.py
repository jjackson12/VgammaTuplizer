...
config.General.requestName = 'Wgamma94XSingleMuonTuples_%s_2017F'%"Jul13"
config.General.workArea = 'crab_jobs_2017F_%s'%"Jul13"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuples_%s_2017F'%"Jul13"
