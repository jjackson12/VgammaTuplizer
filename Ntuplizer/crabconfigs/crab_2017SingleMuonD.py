...
config.General.requestName = 'Wgamma94XSingleMuonTuples_%s_2017D'%"Jul17"
config.General.workArea = 'crab_jobs_2017D_%s'%"Jul17"
...
config.Data.outputDatasetTag = 'Wgamma94XSingleMuonTuples_%s_2017D'%"Jul17"
